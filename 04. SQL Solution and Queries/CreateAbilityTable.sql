...
('Anticipation','Senses a foes dangerous moves.'),
...
('Bad Dreams','Reduces a sleeping foes HP.'),
...
('Dancer','Copies the foes Dance moves.'),
...
('Download','Adjusts power according to a foes defenses.'),
...
('Flash Fire','It powers up Fire-type moves if it is hit by one.'),
('Flower Gift','Powers up party Pokémon when it is sunny.'),
('Flower Veil','Prevents lowering of ally Grass-type Pokémons stats.'),
...
('Frisk','The Pokémon can check a foes held item.'),
...
('Gooey','Contact with the Pokémon lowers the attackers Speed stat.'),
('Gorilla Tactics','Boosts the Pokémons Attack stat but only allows the use of the first selected move.'),
...
('Healer','May heal an allys status conditions.'),
...
('Huge Power','Raises the Pokémons Attack stat.'),
...
('Infiltrator','Passes through the foes barrier and strikes.'),
...
('Intimidate','Lowers the foes Attack stat.'),
...
('Libero','Changes the Pokémons type to its last used move.'),
...
('Merciless','The Pokémons attacks become critical hits if the target is poisoned.'),
...
('Normalize','All the Pokémons moves become the Normal type.'),
...
('Pressure','The Pokémon raises the foes PP usage.'),
...
('Protean','Changes the Pokémons type to its last used move.'),
...
('Pure Power','Raises the Pokémons Attack stat.'),
...
('Receiver','Inherits an allys ability when it faints.'),
...
('Slush Rush','Boosts the Pokémons Speed stat in a hailstorm.'),
...
('Steely Spirit','Powers up ally Pokémons Steel-type moves.'),
...
('Swift Swim','Boosts the Pokémons Speed in rain.'),
...
('Tangling Hair','Contact with the Pokémon lowers the attackers Speed stat.'),
('Technician','Powers up the Pokémons weaker moves.'),
('Telepathy','Anticipates an allys attack and dodges it.'),
...
('Trace','The Pokémon copies a foes Ability.'),
('Triage','Gives priority to restorative moves.'),
('Truant','Pokémon cant attack on consecutive turns.'),
